...
// https://notesontech.com/composer-php-google-api-client-installation/
        ...
        <div
            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="flex items-center space-x-5 justify-center">
                    <p class="text-3xl font-semibold text-blue-600">INSCRIPTION</p>
                </div>

                <div class="mt-5">
                    <label
                        class="font-semibold text-sm text-gray-600 pb-1 block"
                        for="login">E-mail</label>
                    <input
                    ...
                    <label
                        class="font-semibold text-sm text-gray-600 pb-1 block"
                        for="password">Confirmer Mot De Passe</label>
                    <input
                        class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full"
                        type="password"
                        id="password" />
                ...
                <a href="<?= $authUrl ?>" class="flex justify-center w-full items-center">
                    <div>
                        <button
                            ...
                            <span class="ml-2">S'inscrire avec Google</span>
                        </button>
                    </div>
                </a>
                <div class="mt-5">
